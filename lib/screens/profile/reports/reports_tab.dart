              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      RankService.instance.longTitleForLevel(_level),
                      style: TextStyle(
    ...
    try {
      ...
      final bytes = await controller.captureFromWidget(
        ReportShareCard(
          ...
          rank: RankService.instance.shortTitleForLevel(_level),
          level: _level,
          xp: _xp,
      ...
      await Share.shareXFiles(
        [XFile(file.path)],
        text: '⚔️ My Hunter Report — $_hunterName (${RankService.instance.labelForLevel(_level)})\n'
      ...
      // Record that the hunter has shared a report (backs the "Share
      // Report" achievement) and immediately re-evaluate/celebrate.
      try {
        await FirebaseFirestore.instance
            .collection('hunters')
            .doc(widget.uid)
            .update({'hasSharedReport': true});
      } catch (e) {
        debugPrint('shareReport hasSharedReport write: $e');
      }
      if (mounted) {
