...
Future<void> createHunterProfile() async {
  ...
  final docRef = FirebaseFirestore.instance.collection('hunters').doc(user.uid);
  try {
        ...
        return AnnotatedRegion<SystemUiOverlayStyle>(
          value: SystemUiOverlayStyle(
            ...
            statusBarIconBrightness:
                HunterTheme.isDark ? Brightness.light : Brightness.dark,
...
class _HunterProfileLoaderState extends State<_HunterProfileLoader> {
  ...
  Future<DocumentSnapshot> _loadProfile() {
    // Mark the user active for today (ONE Firestore write per day
    // max — the service deduplicates via a local SharedPreferences
    // flag, so retries/rebuilds/restarts never produce extra writes).
    // Fire-and-forget; never blocks the profile load.
    UserActivityService.instance.markActiveToday();
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (context, hunterSnapshot) {
        ...
        final data = hunterSnapshot.data!.data() as Map<String, dynamic>?;
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: RadialGradient(
                          colors: [
                            HunterTheme.primary.withOpacity(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: HunterTheme.primary.withOpacity(
                              0.08 * HunterTheme.glowStrength,
                            ),
                            blurRadius: 18,
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: const Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(Icons.radar, color: Colors.black, size: 18),
                            SizedBox(width: 10),
                            Text(
                              'INITIATE SCAN',
                              style: TextStyle(
  ...
  Widget _dot(double opacity) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: HunterTheme.primary.withOpacity(0.8), blurRadius: 6),
        ],
      ),
    );
  }
